  ...
  return (
    <div className={styles.product}>
      <TopBar
        ...
        pageList={["Home", "All Products", "Product Details"]}
      />
        ...
        <div className={styles.containerLeft}>
          ...
          <div className={styles.inputSection}>
            ...
            >
              ...
              <option value="blue">Sneaker</option>
              <option value="green">Casual</option>
              <option value="black">Outdoor</option>
              <option value="gray">golf</option>
            </select>
          </div>
          <div className={styles.inputSectionFlex}>
            <div className={styles.inputSectionFlexContainer}>
              ...
              <select name={"Color"} className={styles.inputSelect} id="color">
                <option disabled value="default">
                  Color
                </option>
          ...
          <div className={styles.sizesInput}>
            ...
            <div className={styles.sizesInputContainer}>
              <select name={"size"} className={styles.inputSelect} id="size">
                <option disabled value="default">
                  Size
                </option>
        ...
        <div className={styles.containerRight}>
          ...
          <div className={styles.uploadImageContainer}>
            ...
            <span className={styles.uploadBox}>
              ...
              <input className={styles.fileInput} type="file" id="uploadFile" />
            </span>
          </div>
          <div className={styles.uploads}>
            <div className={styles.imageUploads}>
              <Image src="/product.png" alt="product" width={64} height={64} />
              <div className={styles.file}>
                <p className={styles.fileName}>Product thumbnail.png</p>
          ...
          <div className={styles.actionButtons}>
            ...
            <button className={`${styles.button} ${styles.cancel}`}>Update</button>
          </div>
        </div>
      </div>
    </div>
